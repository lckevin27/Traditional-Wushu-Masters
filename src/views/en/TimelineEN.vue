<template>
  <div class="timeline">
    ...
    <div class="scrolling-nav">
      <ul>
        <li><a v-on:click="goto('人物生平')">Introduction</a></li>
        <li v-for="tlc in allMastersEN[$route.params.name].timelineContents" v-bind:key="tlc.tlTitle"><a v-on:click="goto(tlc.tlTitle)">{{ tlc.tlTitle }}</a></li>
      </ul>
    </div>
    <IntroEN id="人物生平"/>
    <TimelineSectionEN id="timeline-section"/>
...
<script>
import IntroEN from '@/components/en/IntroEN.vue'
import TimelineSectionEN from '@/components/en/TimelineSectionEN.vue'
import { mapGetters } from 'vuex'
import NavbarEN from '@/components/en/NavbarEN.vue'
